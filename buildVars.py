...
addon_info = AddonInfo(
	...
	addon_changelog=_("""# Version 2026.05.06
- Ready for NVDA 2026.1
- Turkish, Ukrainian and Viatmese translations.
		"""),
	# Author(s)
	addon_author="Rainer Brell <nvda@brell.net>",
	# URL for the add-on documentation support
	addon_url="https://github.com/rainerbrell/avc/",
	# URL for the add-on repository where the source code can be found
	addon_sourceURL="https://github.com/rainerbrell/avc/",
